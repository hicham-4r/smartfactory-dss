...
final class BrowseProductionKpiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            /*
             * This endpoint calculates execution KPIs. Only statuses that can
             * legitimately have production records are accepted.
             */
            'status' => [
                'nullable',
                Rule::in([
